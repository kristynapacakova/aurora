...
export default function StudioPage() {
  return (
    <main className="flex-1 bg-cream px-6 py-24">
      <div className="mx-auto max-w-3xl">
        <div className="flex justify-end">
          <LogoutButton />
        </div>

        <p className="mb-3 text-center text-sm uppercase tracking-[0.3em] text-accent-d">
          Členská sekce
        </p>
        ...
        <div className="mt-8 rounded-2xl border border-line p-6 sm:p-8">
          <h2 className="font-serif text-2xl text-ink">O lekci</h2>
