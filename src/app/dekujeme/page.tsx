...
export default async function DekujemePage({ searchParams }: Props) {
  ...
  return (
    <main className="flex flex-1 items-center justify-center bg-sand px-6 py-24">
      <div className="w-full max-w-xl rounded-2xl bg-background p-8 text-center shadow-sm ring-1 ring-line sm:p-12">
        ...
        <div className="mx-auto mt-8 flex aspect-square w-48 items-center justify-center rounded-2xl border-2 border-dashed border-line bg-sand text-sm text-foreground/50">
          QR kód platby
        ...
        <div className="mx-auto mt-8 max-w-md rounded-xl bg-sand p-5 text-left text-sm leading-relaxed">
          <p className="mb-2 font-medium uppercase tracking-widest text-accent-dark">
            Důležité upozornění
          </p>
          <p>
        ...
        <Link
          href="/"
          className="mt-10 inline-block rounded-full border border-accent-dark px-8 py-3 text-sm uppercase tracking-widest text-accent-dark transition-colors hover:bg-accent-dark/10"
        >
