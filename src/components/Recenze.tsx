...
// Recenze žen, které chodí na lekce. Načítají se z databáze — klientka je
...
export default async function Recenze() {
  ...
  return (
    <section id="recenze" className="relative overflow-hidden bg-cream pt-14 pb-16 sm:pt-16 sm:pb-20">
      <IconLeafBranch
        size={180}
        ...
        <FadeUp>
          <div className="mb-8 text-center">
            <div className="mb-4 flex items-center justify-center gap-3">
              <IconSparkle size={12} />
              <p className="text-xs uppercase tracking-[0.3em] text-accent">Recenze</p>
              <IconSparkle size={12} />
            </div>
