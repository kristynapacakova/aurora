...
// Listování mezi ohlasy a formulář, kterým může žena přidat svůj.
// Odeslaný ohlas čeká na schválení v administraci — na web se sám nepustí.
    ...
    <>
      ...
      <div className="mt-8 text-center">
        {sent ? (
          ...
          >
            <p className="text-xs uppercase tracking-[0.25em] text-accent">Tvůj ohlas</p>
            ...
            <label className="flex items-start gap-2.5 text-sm text-ink">
              ...
              />
              <span>
                Souhlasím, aby se můj ohlas i s křestním jménem zveřejnil na webu.
              </span>
            </label>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {sending ? "Odesílám…" : "Odeslat ohlas"}
              </button>
              <button
                type="button"
            ...
            <p className="text-xs leading-relaxed text-muted">
              {nbsp(
                "Ohlas se na webu neobjeví hned — nejdřív si ho přečtu. E-mail zůstává jen mně, kdybych se potřebovala ozvat."
              )}
            </p>
          </form>
        )}
